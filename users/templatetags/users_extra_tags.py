...
def facilities(room):
    ...
    to_return = ''
    if room.pc:
        to_return += '<span class="custom-glyphicon glyphicon-computer" aria-hidden="true"></span><span class="sr-only">Computer</span> &nbsp; '
    if room.printer:
        to_return += '<span class="custom-glyphicon glyphicon-printer" aria-hidden="true"></span><span class="sr-only">Printer</span> &nbsp; '
    if room.projector:
        to_return += '<span class="custom-glyphicon glyphicon-projector" aria-hidden="true"></span><span class="sr-only">Projector</span>  &nbsp;'
    if room.blackboard:
        to_return += '<span class="custom-glyphicon glyphicon-blackboard-custom" aria-hidden="true"></span><span class="sr-only">Blackboard</span> &nbsp; '
    if room.whiteboard:
        to_return += '<span class="custom-glyphicon glyphicon-whiteboard" aria-hidden="true"></span><span class="sr-only">Whiteboard</span> &nbsp; '
...
def get_id(room, type):
    ...
    :return: string: location/history id
    """
    if type == 'history':
